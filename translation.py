...
/help для более подробной информации!"""
    FORMAT_SELECTION = "Выберите нужный формат: <a href='{}'>размер файла может быть приблизительным</a> \nЕсли вы хотите установить пользовательскую миниатюру, отправьте фотографию до или быстро после нажатия на любую из кнопок ниже.\nВы можете использовать /deletethumbnail для удаления автоматически сгенерированной миниатюры.."
    SET_CUSTOM_USERNAME_PASSWORD = """Если вы хотите скачать видео премиум-класса, предоставьте его в следующем формате:
Ссылка | имя файла | имя пользователя | Пароль"""
